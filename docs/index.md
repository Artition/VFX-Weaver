...
|---|---|---|
| 26.2 | Fabric | `vfxweaver-2.0.2+26.2.jar` |
| 26.2 | NeoForge | `vfxweaver-2.0.2+26.2-neoforge.jar` |
| 26.1 / 26.1.1 / 26.1.2 | Fabric | `vfxweaver-2.0.2+26.1.2.jar` |
| 26.1 / 26.1.1 / 26.1.2 | NeoForge | `vfxweaver-2.0.2+26.1.2-neoforge.jar` |
| 1.21.11 | Fabric | `vfxweaver-2.0.2+1.21.11.jar` |
...
Modrinth). The documentation also carries a **guide revision** (`Guide v67`); that number tracks the
